package com.microgo.optimization_service.configuration;

import com.microgo.optimization_service.entity.OptimizationResultEntity;
import com.microgo.optimization_service.kafka.configuration.KafkaListenerConfiguration;
...
class InfrastructureMappingTest {
    ...
    @Test
    void optimizationResultJsonFieldsUseHibernateJsonType() throws NoSuchFieldException {
        assertJsonField("demandSummary");
        assertJsonField("baselineMetrics");
        assertJsonField("optimizedMetrics");
    }
    ...
    private void assertJsonField(String fieldName) throws NoSuchFieldException {
        JdbcTypeCode annotation = OptimizationResultEntity.class
